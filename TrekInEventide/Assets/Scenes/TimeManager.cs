...
public class TimeManager : MonoBehaviour
{
    ...
    [Header("Tick Settings")]//how fast our clock moving along
        ...
        /*这里用了就崩了
            ...
            Debug.Log($"Summer Solstice: {DateTime.SummerSolstice(4)}");//夏至
            Debug.Log($"Pumpkin Harvest: {DateTime.PumpkinHarvest(10)}");
            Debug.Log($"Starting of a Season: {DateTime.StartOfSeason(1,3)}");
            Debug.Log($"Starting of a Winter: {DateTime.StartOfWinter(3)}");
         */
    ...
    public struct DateTime
    {
        ...
        public DateTime StartOfAutum(int year)
        {
